...
class FollowCartesianTrajectoryActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FollowCartesianTrajectoryFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FollowCartesianTrajectoryActionFeedback(null);
    ...
    data.feedback = FollowCartesianTrajectoryFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FollowCartesianTrajectoryFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FollowCartesianTrajectoryActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FollowCartesianTrajectoryFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FollowCartesianTrajectoryFeedback()
    }
...
module.exports = FollowCartesianTrajectoryActionFeedback;
